...
def detect(image_id):
    ...
    yolov5_model_path = 'D:\github_fm4l\yolov5'  # Update this path to your YOLOv5 directory
    yolov5_model = torch.hub.load(yolov5_model_path, 'custom', path='D:\github_fm4l\yolov5\runs\train\exp17\weights\best.pt', source='local')
